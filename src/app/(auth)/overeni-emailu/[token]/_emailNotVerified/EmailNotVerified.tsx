...
import EmailNotVerifiedForm from "@/app/(auth)/prihlaseni/_logIn/EmailNotVerifiedForm";
import VerifyLinkSentSuccess from "@/app/(auth)/prihlaseni/_logIn/VerifyLinkSentSuccess";
...
export default function EmailNotVerified({ email }: Props) {
  ...
  const [errors, setErrors] = useState<ResendVerificationEmailFormErrorType>({
    general: getErrorTextByKey("verificationTokenExpired"),
  });
