...
import { fontOrn, fontSerif } from "@/config/app/fonts";
              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span
                      className={`${fontOrn.variable} font-extrabold text-2xl leading-tight tracking-tight text-amber-900 dark:text-amber-100`}
                      style={{ fontFamily: `var(${fontOrn.variable})` }}
                    >
                      Kuchařův
                    </span>
                    <span
                      className={`${fontOrn.variable} font-bold text-lg leading-tight tracking-wide text-amber-700 dark:text-amber-300 -mt-1 flex items-center gap-2`}
                      style={{ fontFamily: `var(${fontOrn.variable})` }}
                    >
                      Deník
                      <svg
                      ...
                      >
                        <path
                          d="M0 5C3 2 8 1 12 1C16 1 20 2 24 3C28 4 32 7 36 5"
                          stroke="currentColor"
                          strokeWidth="0.9"
                          strokeLinecap="round"
