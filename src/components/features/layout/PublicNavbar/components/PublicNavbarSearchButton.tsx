  ...
  ({ onOpen }: PublicNavbarSearchButtonProps) => {
    return (
      <div className="relative group cursor-pointer">
        ...
        {/* Pulse ring */}
        <div className="absolute inset-0 rounded-2xl bg-yellow-500/30 dark:bg-blue-500/30 animate-ping opacity-0 group-hover:opacity-75 transition-opacity duration-300 pointer-events-none" />
        {/* Glow effect */}
