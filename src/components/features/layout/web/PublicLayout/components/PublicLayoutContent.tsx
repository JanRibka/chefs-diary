import { usePublicLayoutAnimations } from "../hooks/usePublicLayoutAnimations";

/**
 * PublicLayoutContent - Main content wrapper with animations and floating elements
 *
...
export const PublicLayoutContent = ({ children }: PublicLayoutContentProps) => {
  const animations = usePublicLayoutAnimations();
