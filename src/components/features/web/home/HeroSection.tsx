      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10 text-center lg:text-left">
            {/* Premium badge */}
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-100 via-red-50 to-pink-100 dark:from-orange-900/40 dark:via-red-900/30 dark:to-pink-900/40 px-6 py-3 rounded-full text-orange-800 dark:text-orange-200 text-sm font-semibold border border-orange-200/50 dark:border-orange-800/50 backdrop-blur-sm shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
              ...
              <Button
                ...
                size="lg"
                variant="bordered"
                className="font-bold px-10 py-4 text-lg rounded-2xl border-3 border-slate-300 dark:border-slate-600 hover:border-orange-500 dark:hover:border-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all duration-300 backdrop-blur-sm"
